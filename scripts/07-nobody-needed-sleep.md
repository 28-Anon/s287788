# 07 — WHAT IF NOBODY NEEDED SLEEP

**Scene:** one bedroom. The camera never leaves it; the city is seen through the window.
**Runtime:** 69s. 22 beats — 15 to the payoff, then a spoken close · 123 words.
**Payoff image:** the whole city lit to the horizon, not one dark window.
...
| 9 | 0:24 | **BUT WHAT IF YOU COULD NEVER STOP?** | the lamp — no switch on it |
| 10 | 0:27 | NOTHING MAKES ANYONE PAUSE | the window: nothing ever dims |
| 11 | 0:30 | THE SHOPS NEVER SHUT | signs across the street, always on |
| 12 | 0:33 | NOBODY IS EVER OFF | phone on the nightstand, always buzzing |
| 13 | 0:36 | THERE IS NO NIGHT TO HIDE IN | the room — no shadows anywhere in it |
| 14 | 0:39 | SLEEP WAS NEVER REST | the bed, never slept in |
| 15 | 0:42 | IT WAS THE ONLY THING THAT STOPPED US | final image: pull back through the window — the city lit to the horizon, no darkness anywhere |
| 16 | 0:45 | EVERY OTHER LIMIT WE FOUND A WAY AROUND | the lit city |
| 17 | 0:48 | DISTANCE. DARKNESS. BEING UNREACHABLE. | three cuts through the same window |
| 18 | 0:51 | SLEEP WAS THE LAST ONE LEFT | the bed, never slept in |
| 19 | 0:54 | THE ONE NOBODY COULD ASK YOU TO SKIP | the phone, buzzing |
| 20 | 0:57 | AND YOU ALREADY GIVE IT AWAY | a face lit by a screen in the dark |
| 21 | 1:00 | SO BE HONEST | the bed |
| 22 | 1:03 | WOULD YOU TAKE THE EIGHT HOURS? | the city lit to the horizon. question held |
| — | 1:06 | *(no captions)* | outro card, 3s |

**Notes.** Pivot 1 removes your advantage — everyone gets the hours, so the gain
evaporates. Pivot 2 removes the option to opt out. The true payoff underneath:
sleep is the only stop nobody can be competed out of. Delete it and there is no
hour left that isn't contested.
