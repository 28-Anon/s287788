...
The first three seconds decide everything. Four openers per script, each
fishing for a different viewer. Shoot A and one other, post both, keep the
winner.
...
**Pick C to scale.** It's a flat contradiction in nine words. People stay to
