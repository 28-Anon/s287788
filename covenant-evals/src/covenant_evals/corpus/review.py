...
ORIENTATION = (
    ...
    "does this document restrict what the borrower may do?",
    "",
    "  KEEP   it has restrictions you could ask about. Ctrl+F any of:",
    "           'Negative Covenants'   'shall not incur'   'Restricted Payments'",
    "         That is the whole test. LENGTH IS A PREFERENCE, NOT A RULE — a long",
    "         agreement gives more and harder questions, but a short one with real",
    "         covenants is worth keeping and makes a useful easy end of the range.",
    "",
    "  DROP   no restrictions at all; or it is an amendment, waiver, supplement,",
    "         guarantee, security or pledge agreement — attached to a loan, not the",
    "         loan itself.",
    "",
    ...
    "",
    "The other useful search is 'governed by', which lands on the governing law.",
    "",
    "TRAP: 'Amended and Restated Credit Agreement' is a KEEP — it is a complete,",
    "current agreement. 'Amendment No. 3 to Credit Agreement' is a DROP. The tell is",
    "the word 'Amendment'. Full reference in docs/DOCUMENT-TYPES.md.",
    "",
